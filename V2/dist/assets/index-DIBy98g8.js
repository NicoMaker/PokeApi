...
function Mh() {
  ...
  (A.prototype.isReactComponent = {}),
    (A.prototype.setState = function (x, F) {
  ...
  var M = (K.prototype = new B());
  (M.constructor = K), R(M, A.prototype), (M.isPureReactComponent = !0);
  var b = Array.isArray,
  ...
  function ce(x, F, se) {
    ...
    if (x && x.defaultProps)
      for (ue in ((we = x.defaultProps), we))
        de[ue] === void 0 && (de[ue] = we[ue]);
    return {
      $$typeof: r,
      type: x,
      key: pe,
  ...
  function ke(x, F, se, ue, de) {
    ...
    if (((Ee = 0), (ue = ue === "" ? "." : ue + ":"), b(x)))
      ...
      for (x = Ae.call(x), we = 0; !(pe = x.next()).done; )
        (pe = pe.value),
          (Ae = ue + le(pe, we++)),
          (Ee += ke(pe, F, se, Ae, de));
    else if (pe === "object")
  ...
  return (
    ...
    (ae.cloneElement = function (x, F, se) {
      ...
      if (F != null) {
        if (
          (F.ref !== void 0 && ((pe = F.ref), (Ee = J.current)),
        ...
        for (Ae in F)
          V.call(F, Ae) &&
            !W.hasOwnProperty(Ae) &&
            (ue[Ae] = F[Ae] === void 0 && we !== void 0 ? we[Ae] : F[Ae]);
      }
    ...
    (ae.useImperativeHandle = function (x, F, se) {
      return Pe.current.useImperativeHandle(x, F, se);
    }),
    ...
    (ae.useReducer = function (x, F, se) {
      return Pe.current.useReducer(x, F, se);
    }),
    ...
    (ae.useSyncExternalStore = function (x, F, se) {
      return Pe.current.useSyncExternalStore(x, F, se);
    }),
  ...
  return (
    rd ||
      ...
      (function (r) {
        ...
        function b(U) {
          if (((_ = !1), M(U), !R))
            if (l(w) !== null) (R = !0), be(V);
            else {
              var ne = l(v);
              ne !== null && Pe(b, ne.startTime - U);
            }
        }
        function V(U, ne) {
          (R = !1), _ && ((_ = !1), B(ce), (ce = -1)), ($ = !0);
          var q = O;
          try {
            for (
              M(ne), k = l(w);
            ...
            if (k !== null) var se = !0;
              ...
              var ue = l(v);
              ue !== null && Pe(b, ue.startTime - ne), (se = !1);
            }
            return se;
          } finally {
            (k = null), (O = q), ($ = !1);
            ...
            return (
              ...
              q > x
                ? ((U.sortIndex = q),
                  ...
                  l(w) === null &&
                    U === l(v) &&
                    (_ ? (B(ce), (ce = -1)) : (_ = !0), Pe(b, q - x)))
                : ((U.sortIndex = F), o(w, U), R || $ || ((R = !0), be(V))),
              U
            );
          }),
...
function Wh() {
  ...
  function M(e, t, n, i) {
    var s = A.hasOwnProperty(t) ? A[t] : null;
    (s !== null
      ? s.type !== 0
      : i ||
        !(2 < t.length) ||
...
` + s[d].replace(" at new ", " at ");
  ...
  function El(e, t) {
    ...
    t.hasOwnProperty("value")
      ? Tl(e, t.type, n)
      : t.hasOwnProperty("defaultValue") && Tl(e, t.type, we(t.defaultValue)),
      t.checked == null &&
    ...
    function H(E, S, T, j, Z) {
      ...
      if (typeof j == "object" && j !== null) {
        switch (j.$$typeof) {
          ...
          case J:
            return (
              (E = E.get(j.key === null ? T : j.key) || null), P(S, E, j, Z)
            );
          case be:
            var ee = j._init;
...
` +
  ...
  function vf(e, t, n, i, s) {
    ...
    if ((cr(t, s), t.stateNode === null))
      ...
      (d = t.stateNode),
        zc(e, t),
        (g = t.memoizedProps),
        (P = t.type === t.elementType ? g : It(t.type, g)),
        (d.props = P),
        (I = t.pendingProps),
        (z = d.context),
        (y = n.contextType),
  ...
  function wh(e, t) {
    ...
    for (
      as = { focusedElem: e, selectionRange: n }, Wo = !1, Q = t;
      Q !== null;
    ...
    switch (e.tag) {
      ...
      case 22:
        if (
          ...
          e.mode & 1 ? ((rt = (P = rt) || D), jt(t, e), (rt = P)) : jt(t, e),
          Wt(e),
          i & 8192)
        ) {
          if (
          ...
          e: for (D = null, I = e; ; ) {
            if (I.tag === 5) {
              ...
              if (D === null)
                try {
                  I.stateNode.nodeValue = P ? "" : I.memoizedProps;
                } catch (Y) {
                  De(e, e.return, Y);
                }
            } else if (
            ...
            for (Q = s; Q !== null; )
              (d = Q),
                ...
                d.tag === 22 && d.memoizedState !== null
                  ...
                  ? ((y.return = d), (Q = y))
                  : $f(s);
          for (; c !== null; ) (Q = c), Ff(c), (c = c.sibling);
          (Q = s), (Ti = g), (rt = P);
        }
        Df(e);
      } else
        s.subtreeFlags & 8772 && c !== null ? ((c.return = s), (Q = c)) : Df(e);
    }
  }
  function Df(e) {
    for (; Q !== null; ) {
  ...
  function jn(e) {
    ...
    try {
      ...
      (Se = i), (Ot.transition = n), (fe = t), !(fe & 6) && vn();
    }
  }
  function sa() {
    (St = mr.current), Oe(mr);
  ...
  function Mn(e, t, n) {
    var i = Se,
      s = Ot.transition;
    try {
      (Ot.transition = null), (Se = 1), Th(e, t, n, i);
    } finally {
...
var qh = Qh(),
  _e = ba();
const Gh = Bh(_e),
  ad = jh({ __proto__: null, default: Gh }, [_e]);
function sn(r) {
          ...
          if ($ != null)
            if (typeof $ == "object")
              if (f[O]) k = Co(k, r(O, $, u, f));
                ...
                const R = an({ theme: u }, $, (_) => ({ [O]: _ }));
                K0(R, $) ? (k[O] = o({ sx: $, theme: u })) : (k = Co(k, R));
              }
            else k = Co(k, r(O, $, u, f));
        }),
        r0(u, u0(C, k))
  ...
  for (
    ...
    switch (((R = K), (K = xt()))) {
      ...
      default:
        if (_ < 1) {
          if (K == 123) --_;
          else if (K == 125 && _++ == 0 && ug() == 125) continue;
        }
        switch (((W += pl(K)), K * _)) {
          case 38:
            B = C > 0 ? 1 : ((W += "\f"), -1);
...
function dd(r, o, l, a, u, f, p, m, w, v, C) {
  for (
    var k = u - 1, O = u === 0 ? f : [""], $ = Ga(O), R = 0, _ = 0, A = 0;
    R < a;
    ++R
  )
    for (var B = 0, K = xo(r, k + 1, (k = rg((_ = p[R])))), M = r; B < $; ++B)
      (M = Jd(_ > 0 ? O[B] + " " + K : ge(K, /&\f/g, O[B]))) && (w[A++] = M);
  ...
  _g = function (o) {
    ...
    (p = o.container || document.head),
      Array.prototype.forEach.call(
        ...
        function (_) {
          for (
            var A = _.getAttribute("data-emotion").split(" "), B = 1;
            B < A.length;
            B++
          )
            f[A[B]] = !0;
      ...
      v = [Cg, xg];
    {
      ...
      w = function (A, B, K, M) {
        (C = K),
          $(A ? A + "{" + B.styles + "}" : B.styles),
          M && (R.inserted[B.name] = !0);
      };
    }
    var R = {
      key: l,
...
var $g = function (o) {
  ...
  Bg = jg || $g,
  lp = _e.createContext(typeof HTMLElement < "u" ? _g({ key: "css" }) : null);
lp.Provider;
var Mg = function (o) {
    return _e.forwardRef(function (l, a) {
      var u = _e.useContext(lp);
      return o(l, u, a);
    });
  },
  Ug = _e.createContext({}),
    ...
    return function () {
      ...
      var R = Mg(function (_, A, B) {
        ...
        if (_.theme == null) {
          ...
          V.theme = _e.useContext(Ug);
        }
        typeof _.className == "string"
          ? (M = Rg(A.registered, b, _.className))
          : _.className != null && (M = _.className + " ");
        var W = ip(k.concat(b), A.registered, V);
        (M += A.key + "-" + W.name), p !== void 0 && (M += " " + p);
        var ce = v && m === void 0 ? vd(K) : w,
          ve = {};
        for (var h in _) (v && h === "as") || (ce(h) && (ve[h] = _[h]));
        return (
          (ve.className = M),
          B && (ve.ref = B),
          _e.createElement(
      ...
      return (
        ...
        (R.withComponent = function (_, A) {
          return r(_, Aa({}, l, A, { shouldForwardProp: wd(R, A, !0) })).apply(
            void 0,
            k
          );
        }),
...
function Yg(r) {
  ...
  function v(O, $) {
    ...
    return `@media (min-width:${
      ...
      (R !== -1 && typeof o[p[R]] == "number" ? o[p[R]] : $) - a / 100
    }${l})`;
  }
  function C(O) {
...
function ry(r = {}) {
  ...
  return (m, w = {}) => {
    ...
    C === "Root" || C === "root"
      ...
      ? (B = u)
      : ly(m) && (B = void 0);
    const K = qg(m, { shouldForwardProp: B, label: oy(), ...R }),
      M = (V) => {
        ...
        if (
          ...
          v &&
            ...
            ce.push(function (re) {
              ...
              if (!ke) return null;
              const je = {};
              for (const U in ke) je[U] = Xi(re, ke[U]);
              return $(re, je);
            }),
          v &&
            !_ &&
...
const py = _e.createContext(void 0);
function my(r) {
...
function Sy(r, o = {}) {
  ...
  if (
    ...
    const { css: M, vars: b, varsWithDefaults: V } = xa(R, o);
  ...
  return {
    ...
    generateStyleSheets: () => {
      ...
      if (J) {
        const { css: h } = J,
          G =
            (ve = (ce = f[b]) == null ? void 0 : ce.palette) == null
              ? void 0
              : ve.mode,
      ...
      return (
        Object.entries(W).forEach(([h, { css: G }]) => {
          var ke, je;
          const re =
              (je = (ke = f[h]) == null ? void 0 : ke.palette) == null
                ? void 0
                : je.mode,
...
function Za(r) {
  ...
  const O = ({
    ...
    if (
      ...
      throw new Error(Vn(11, A ? ` (${A})` : "", B));
    if (typeof _.main != "string")
      throw new Error(Vn(12, A ? ` (${A})` : "", JSON.stringify(_.main)));
    return (
      Td(_, "light", K, a),
      Td(_, "dark", M, a),
...
function zy(r, o) {
  const {
    ...
    _ = {
      ...
      button: R(p, 14, 1.75, 0.4, _d),
      caption: R(f, 12, 1.66, 0.4),
      overline: R(f, 12, 2.66, 1, _d),
      inherit: {
        fontFamily: "inherit",
        fontWeight: "inherit",
        fontSize: "inherit",
...
function Zy(r = {}, ...o) {
  ...
  Object.keys(b.colorSchemes).forEach((ve) => {
    const h = b.colorSchemes[ve].palette,
      G = (re) => {
        const le = re.split("-"),
          ke = le[1],
          je = le[2];
    ...
    if (
      ...
      L(h.Alert, "errorColor", Ce(h.error.light, 0.6)),
        ...
        L(h.Alert, "errorStandardBg", xe(h.error.light, 0.9)),
        L(h.Alert, "infoStandardBg", xe(h.info.light, 0.9)),
        L(h.Alert, "successStandardBg", xe(h.success.light, 0.9)),
        L(h.Alert, "warningStandardBg", xe(h.warning.light, 0.9)),
        ...
        L(h.LinearProgress, "primaryBg", xe(h.primary.main, 0.62)),
        L(h.LinearProgress, "secondaryBg", xe(h.secondary.main, 0.62)),
        L(h.LinearProgress, "errorBg", xe(h.error.main, 0.62)),
        L(h.LinearProgress, "infoBg", xe(h.info.main, 0.62)),
        L(h.LinearProgress, "successBg", xe(h.success.main, 0.62)),
        L(h.LinearProgress, "warningBg", xe(h.warning.main, 0.62)),
        L(h.Skeleton, "bg", `rgba(${G("palette-text-primaryChannel")} / 0.11)`),
        L(h.Slider, "primaryTrack", xe(h.primary.main, 0.62)),
        L(h.Slider, "secondaryTrack", xe(h.secondary.main, 0.62)),
        L(h.Slider, "errorTrack", xe(h.error.main, 0.62)),
        L(h.Slider, "infoTrack", xe(h.info.main, 0.62)),
        L(h.Slider, "successTrack", xe(h.success.main, 0.62)),
        L(h.Slider, "warningTrack", xe(h.warning.main, 0.62));
      ...
      L(h.SnackbarContent, "bg", re),
        ...
        L(h.Switch, "primaryDisabledColor", xe(h.primary.main, 0.62)),
        L(h.Switch, "secondaryDisabledColor", xe(h.secondary.main, 0.62)),
        L(h.Switch, "errorDisabledColor", xe(h.error.main, 0.62)),
        L(h.Switch, "infoDisabledColor", xe(h.info.main, 0.62)),
        L(h.Switch, "successDisabledColor", xe(h.success.main, 0.62)),
        L(h.Switch, "warningDisabledColor", xe(h.warning.main, 0.62)),
        L(h.TableCell, "border", xe(Wi(h.divider, 1), 0.88)),
        L(h.Tooltip, "bg", Wi(h.grey[700], 0.92));
    }
    if (h.mode === "dark") {
      L(h.Alert, "errorColor", xe(h.error.light, 0.6)),
        L(h.Alert, "infoColor", xe(h.info.light, 0.6)),
        L(h.Alert, "successColor", xe(h.success.light, 0.6)),
        L(h.Alert, "warningColor", xe(h.warning.light, 0.6)),
        ...
        L(h.LinearProgress, "primaryBg", Ce(h.primary.main, 0.5)),
        L(h.LinearProgress, "secondaryBg", Ce(h.secondary.main, 0.5)),
        L(h.LinearProgress, "errorBg", Ce(h.error.main, 0.5)),
        L(h.LinearProgress, "infoBg", Ce(h.info.main, 0.5)),
        L(h.LinearProgress, "successBg", Ce(h.success.main, 0.5)),
        L(h.LinearProgress, "warningBg", Ce(h.warning.main, 0.5)),
        L(h.Skeleton, "bg", `rgba(${G("palette-text-primaryChannel")} / 0.13)`),
        L(h.Slider, "primaryTrack", Ce(h.primary.main, 0.5)),
        L(h.Slider, "secondaryTrack", Ce(h.secondary.main, 0.5)),
        L(h.Slider, "errorTrack", Ce(h.error.main, 0.5)),
        L(h.Slider, "infoTrack", Ce(h.info.main, 0.5)),
        L(h.Slider, "successTrack", Ce(h.success.main, 0.5)),
        L(h.Slider, "warningTrack", Ce(h.warning.main, 0.5));
      ...
      L(h.SnackbarContent, "bg", re),
        ...
        L(h.Switch, "primaryDisabledColor", Ce(h.primary.main, 0.55)),
        L(h.Switch, "secondaryDisabledColor", Ce(h.secondary.main, 0.55)),
        L(h.Switch, "errorDisabledColor", Ce(h.error.main, 0.55)),
        L(h.Switch, "infoDisabledColor", Ce(h.info.main, 0.55)),
        L(h.Switch, "successDisabledColor", Ce(h.success.main, 0.55)),
        L(h.Switch, "warningDisabledColor", Ce(h.warning.main, 0.55)),
        L(h.TableCell, "border", Ce(Wi(h.divider, 1), 0.68)),
        L(h.Tooltip, "bg", Wi(h.grey[700], 0.92));
    }
  ...
  return (
    (b.vars = J),
    Object.entries(b.colorSchemes[b.defaultColorScheme]).forEach(([ve, h]) => {
      b[ve] = h;
    }),
      ...
      return {
        ...
        variants: [
          ...
          ...Object.entries((r.vars ?? r).palette)
            ...
            .map(([_]) => {
              ...
              return {
                ...
                style: {
                  color:
                    (B = (A = (r.vars ?? r).palette) == null ? void 0 : A[_]) ==
                    null
                      ? void 0
                      : B.main,
                },
          ...
          },
          {
            ...
            style: {
              color:
                (R = ($ = (r.vars ?? r).palette) == null ? void 0 : $.action) ==
                null
                  ? void 0
                  : R.disabled,
            },
  ...
  nl = _e.forwardRef(function (o, l) {
    ...
    return ye.jsxs(c1, {
      ...
      children: [
        ...
        k ? ye.jsx("title", { children: k }) : null,
      ],
    });
  });
...
function yp(r, o) {
  function l(a, u) {
    return ye.jsx(nl, { "data-testid": `${o}Icon`, ref: u, ...a, children: r });
  }
  ...
  return ye.jsxs("div", {
    ...
    children: [
      ...
      ye.jsxs("div", {
        className: "card-body",
        children: [
          ye.jsx("h5", { className: "card-title", children: r.name }),
          ye.jsx("p", {
            className: "card-text",
...
function ev(r) {
  return N.isArray(r) && !r.some($a);
}
const tv = N.toFlatObject(N, {}, null, function (o) {
  return /^is[A-Z]/.test(o);
});
function Sl(r, o, l) {
  if (!N.isObject(r)) throw new TypeError("target must be an object");
  (o = o || new FormData()),
    (l = N.toFlatObject(
      l,
  ...
  const a = l.metaTokens,
    ...
    f = l.dots,
    p = l.indexes,
    w = (l.Blob || (typeof Blob < "u" && Blob)) && N.isSpecCompliantForm(o);
  if (!N.isFunction(u)) throw new TypeError("visitor must be a function");
  function v(R) {
    if (R === null) return "";
    if (N.isDate(R)) return R.toISOString();
    if (!w && N.isBlob(R))
      throw new ie("Blob is not supported. Use a Buffer instead.");
    return N.isArrayBuffer(R) || N.isTypedArray(R)
  ...
  function C(R, _, A) {
    ...
    if (R && !A && typeof R == "object") {
      if (N.endsWith(_, "{}"))
        ...
        (N.isArray(R) && ev(R)) ||
        ((N.isFileList(R) || N.endsWith(_, "[]")) && (B = N.toArray(R)))
      )
        return (
          (_ = Rp(_)),
    ...
    return $a(R) ? !0 : (o.append(Ld(A, _, f), v(R)), !1);
  }
  const k = [],
    O = Object.assign(tv, {
      defaultVisitor: C,
  ...
  function $(R, _) {
    if (!N.isUndefined(R)) {
      ...
      k.push(R),
        N.forEach(R, function (B, K) {
          (!(N.isUndefined(B) || B === null) &&
            u.call(o, B, N.isString(K) ? K.trim() : K, _, O)) === !0 &&
            $(B, _ ? _.concat(K) : [K]);
        }),
        k.pop();
    }
  }
  if (!N.isObject(r)) throw new TypeError("data must be an object");
  return $(r), o;
}
function zd(r) {
  const o = {
...
function Ap(r, o, l) {
  ...
  N.isFunction(l) && (l = { serialize: l });
  const u = l && l.serialize;
  let f;
  if (
    (u
      ? (f = u(o, l))
      : (f = N.isURLSearchParams(o) ? o.toString() : new tu(o, l).toString(a)),
    f)
  ) {
    const p = r.indexOf("#");
    p !== -1 && (r = r.slice(0, p)),
...
function dv(r) {
  return N.matchAll(/\w+|\[(\w*)]/g, r).map((o) =>
    o[0] === "[]" ? "" : o[1] || o[0]
  );
}
function pv(r) {
...
function Lp(r) {
  function o(l, a, u, f) {
    ...
    const m = Number.isFinite(+p),
      w = f >= l.length;
    return (
      (p = !p && N.isArray(u) ? u.length : p),
      w
        ? (N.hasOwnProp(u, p) ? (u[p] = [u[p], a]) : (u[p] = a), !m)
        : ((!u[p] || !N.isObject(u[p])) && (u[p] = []),
          o(l, a, u[p], f) && N.isArray(u[p]) && (u[p] = pv(u[p])),
          !m)
    );
  }
...
function mv(r, o, l) {
  if (N.isString(r))
    try {
      return (o || JSON.parse)(r), N.trim(r);
    } catch (a) {
...
const Lo = {
  ...
  transformRequest: [
    function (o, l) {
      const a = l.getContentType() || "",
        ...
        f = N.isObject(o);
      if ((f && N.isHTMLForm(o) && (o = new FormData(o)), N.isFormData(o)))
      ...
      if (
        ...
        N.isFile(o) ||
        N.isBlob(o) ||
        N.isReadableStream(o)
      )
        return o;
      if (N.isArrayBufferView(o)) return o.buffer;
      if (N.isURLSearchParams(o))
        return (
          l.setContentType(
      ...
      if (f) {
        ...
        if ((m = N.isFileList(o)) || a.indexOf("multipart/form-data") > -1) {
  ...
  transformResponse: [
    function (o) {
      ...
      if (o && N.isString(o) && ((a && !this.responseType) || u)) {
...
function Ji(r) {
  return r === !1 || r == null ? r : N.isArray(r) ? r.map(Ji) : String(r);
}
function yv(r) {
...
function _a(r, o, l, a, u) {
  if (N.isFunction(a)) return a.call(this, o, l);
  if ((u && (o = l), !!N.isString(o))) {
    if (N.isString(a)) return o.indexOf(a) !== -1;
    if (N.isRegExp(a)) return a.test(o);
  }
}
function wv(r) {
  return r
...
class mt {
  ...
  set(o, l, a) {
    ...
    function f(m, w, v) {
      ...
      const k = N.findKey(u, C);
      (!k || u[k] === void 0 || v === !0 || (v === void 0 && u[k] !== !1)) &&
        (u[k || w] = Ji(m));
    }
    const p = (m, w) => N.forEach(m, (v, C) => f(v, C, w));
    if (N.isPlainObject(o) || o instanceof this.constructor) p(o, l);
    else if (N.isString(o) && (o = o.trim()) && !vv(o)) p(gv(o), l);
    else if (N.isHeaders(o)) for (const [m, w] of o.entries()) f(w, m, a);
    else o != null && f(l, o, a);
    return this;
  }
  get(o, l) {
    if (((o = wo(o)), o)) {
      const a = N.findKey(this, o);
      if (a) {
        const u = this[a];
        if (!l) return u;
        if (l === !0) return yv(u);
        if (N.isFunction(l)) return l.call(this, u, a);
        if (N.isRegExp(l)) return l.exec(u);
  ...
  delete(o, l) {
    ...
    function f(p) {
      if (((p = wo(p)), p)) {
        const m = N.findKey(a, p);
        m && (!l || _a(a, a[m], m, l)) && (delete a[m], (u = !0));
      }
    }
    return N.isArray(o) ? o.forEach(f) : f(o), u;
  }
  clear(o) {
  ...
  toJSON(o) {
    ...
    return (
      N.forEach(this, (a, u) => {
        a != null && a !== !1 && (l[u] = o && N.isArray(a) ? a.join(", ") : a);
      }),
      l
    );
  }
...
`);
  ...
  static accessor(o) {
    ...
    return N.isArray(o) ? o.forEach(f) : f(o), this;
  }
}
mt.accessor([
  "Content-Type",
...
N.reduceDescriptors(mt.prototype, ({ value: r }, o) => {
  ...
  Tv = it.hasStandardBrowserEnv
    ? {
        write(r, o, l, a, u, f) {
          ...
          N.isNumber(l) && p.push("expires=" + new Date(l).toGMTString()),
            N.isString(a) && p.push("path=" + a),
            N.isString(u) && p.push("domain=" + u),
            f === !0 && p.push("secure"),
...
function Wn(r, o) {
  ...
  const l = {};
  function a(v, C, k, O) {
    return N.isPlainObject(v) && N.isPlainObject(C)
      ? N.merge.call({ caseless: O }, v, C)
      : N.isPlainObject(C)
      ? N.merge({}, C)
      : N.isArray(C)
      ? C.slice()
  ...
  function u(v, C, k, O) {
    if (N.isUndefined(C)) {
      if (!N.isUndefined(v)) return a(void 0, v, k, O);
  ...
  function p(v, C) {
    if (N.isUndefined(C)) {
      if (!N.isUndefined(v)) return a(void 0, v);
  ...
  return (
    N.forEach(Object.keys(Object.assign({}, r, o)), function (C) {
      const k = w[C] || u,
        O = k(r[C], o[C], C);
      (N.isUndefined(O) && k !== m) || (l[C] = O);
    }),
    l
  );
}
const Ip = (r) => {
    ...
    if (
      ...
      (a && N.isFunction(a) && (a = a(o)), a || (a !== !1 && Ev(o.url)))
    ) {
  ...
  Ov =
    ...
    function (r) {
      return new Promise(function (l, a) {
        ...
        A.open(u.method.toUpperCase(), u.url, !0), (A.timeout = u.timeout);
        function B() {
          if (!A) return;
          const M = mt.from(
        ...
        "onloadend" in A
          ...
          (A.onabort = function () {
            A &&
              (a(new ie("Request aborted", ie.ECONNABORTED, r, A)), (A = null));
          }),
          (A.onerror = function () {
            a(new ie("Network Error", ie.ERR_NETWORK, r, A)), (A = null);
          }),
          ...
          "setRequestHeader" in A &&
            N.forEach(p.toJSON(), function (b, V) {
              A.setRequestHeader(V, b);
            }),
          N.isUndefined(u.withCredentials) ||
            (A.withCredentials = !!u.withCredentials),
          m && m !== "json" && (A.responseType = u.responseType),
          v && (([O, R] = rl(v, !0)), A.addEventListener("progress", O)),
          w &&
            A.upload &&
            (([k, $] = rl(w)),
            A.upload.addEventListener("progress", k),
            A.upload.addEventListener("loadend", $)),
          (u.cancelToken || u.signal) &&
            ((C = (M) => {
              A &&
                (a(!M || M.type ? new Or(null, r, A) : M),
                A.abort(),
                (A = null));
            }),
  ...
  Av = (r, o) => {
    ...
    if (o || l) {
      ...
      const { signal: w } = a;
      return (w.unsubscribe = () => N.asap(m)), w;
    }
  },
  Nv = function* (r, o) {
    let l = r.byteLength;
    ...
    (async (r) => {
      ...
      try {
        ...
        if (Ba && (m || (M && _))) {
          ...
          const J = N.toFiniteNumber(K.headers.get("content-length")),
        ...
        v = v || "text";
        let b = await ol[N.findKey(ol, v) || "text"](K, r);
        return (
          !M && _ && _(),
...
const Ud = (r) => `- ${r}`,
  Bv = (r) => N.isFunction(r) || r === null || r === !1,
  Bp = {
    getAdapter: (r) => {
      r = N.isArray(r) ? r : [r];
      const { length: o } = r;
...
` + f)
  ...
  _request(o, l) {
    ...
    let p = f && N.merge(f.common, f[l.method]);
    f &&
      N.forEach(
...
function Up(r) {
  ...
  return (
    N.extend(l, Hn.prototype, o, { allOwnKeys: !0 }),
    N.extend(l, o, null, { allOwnKeys: !0 }),
    (l.create = function (u) {
      return Up(Wn(r, u));
    }),
    l
...
We.mergeConfig = Wn;
We.AxiosHeaders = mt;
We.formToJSON = (r) => Lp(N.isHTMLForm(r) ? new FormData(r) : r);
...
function Hv() {
  const [r, o] = _e.useState(void 0),
    [l, a] = _e.useState("https://pokeapi.co/api/v2/pokemon/"),
    [u, f] = _e.useState(1),
    [p, m] = _e.useState(0),
    [w, v] = _e.useState(!1),
    C = 12,
    ...
    O = async () => {
      ...
      const B = {
        ...A,
        results: await Promise.all(A.results.map((K) => Vd(K.url))),
      };
      o(B), v(!1);
    },
    $ = (A) => {
      const B = (A - 1) * C;
      a(`https://pokeapi.co/api/v2/pokemon?offset=${B}&limit=${C}`), f(A);
    },
    R = () => {
      u < k ? $(u + 1) : $(1);
    },
    _ = () => {
      u > 1 ? $(u - 1) : alert("Sei già alla prima pagina!");
    };
  return (
    _e.useEffect(() => {
      $(1);
    ...
    ye.jsxs("div", {
      ...
      children: [
        ye.jsxs("h2", { children: ["Pagina ", u, " di ", k || "?"] }),
        ye.jsxs("div", {
          ...
          children: [
            ye.jsx("button", {
              ...
              className: "arrowback",
              onClick: _,
              children: ye.jsx(f1, { className: "icon" }),
            }),
            ye.jsx("button", {
              type: "button",
              className: "arrowforward",
              onClick: R,
              children: ye.jsx(d1, { className: "icon" }),
            }),
          ],
        }),
        w
          ? ye.jsxs("div", {
              ...
              children: [
                ...
                ye.jsx("div", { className: "spinner" }),
                ye.jsx("p", { children: "Caricamento in corso..." }),
              ],
            })
          : ye.jsx("div", {
              className: "card-grid",
              children:
                r && r.results.map((A) => ye.jsx(p1, { pokemon: A }, A.name)),
            }),
      ],
    })
  );
...
qh.createRoot(document.getElementById("root")).render(ye.jsx(Vv, {}));
